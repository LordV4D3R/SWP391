 ...
 * @author Admin
 */
@WebServlet(name = "ViewProductByCategoryController", urlPatterns = {"/ViewProductByCategoryController"})
public class ViewProductByCategoryController extends HttpServlet {
