<%-- 
    Document   : gallery
    Created on : Sep 27, 2022, 12:43:03 PM
    Author     : thangbv
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Site Metas -->
        <title>${sessionScope.POST_DETAILS.postTitle}</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="ViewListBlogController">Blog</a></li>
                            <li class="breadcrumb-item active">${sessionScope.POST_DETAILS.postTitle}</li>
                        </ul>
                    </div>
                </div>
            </div>
